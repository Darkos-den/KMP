...
internal class EncryptionKeysStorage {
    ...
    private fun clearKeys(keyStore: KeyStore, preferences: Preferences) =
            ...
            preferences.edit {
                putString(
                    ...
                    encodeToString(
                        encryptKey(
                            generateRandomKey(),
                            keyStore.getSecretKey(it.keystoreKeyAlias)
                        )
                    )
                )
            }
    ...
    private fun encodeToString(byteArray: ByteArray) =
    ...
    private fun decrypt(encryptedData: ByteArray, key: Key) =
    ...
    private fun extractIvAndEncryptedKey(encryptedData: ByteArray) =
        with(ByteBuffer.wrap(encryptedData)) {
    ...
    private fun KeyStore.getSecretKey(alias: String) =
 ...
 */
internal enum class EncryptionKey(
    internal val keyAlias: String,
    internal val keystoreKeyAlias: String
) {
